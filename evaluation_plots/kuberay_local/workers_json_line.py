...
with open("energy_power_data_ray_workers_line.json", "w") as f:
    json.dump(data, f, indent=2)
print("Prometheus data saved as energy_power_data_ray_workers_line.json")
...
total_duration = 1913.7656075954437
phase_durations = [
    214.18900322914124,      # Phase 1
    1683.5806121826172,      # Phase 2
    15.995992183685303       # Phase 3
]
...
fig.tight_layout()
plt.savefig("energy_power_plot_ray_workers_line.png", bbox_inches='tight')
plt.show()
print("Plot saved as energy_power_plot_ray_workers_line.png")