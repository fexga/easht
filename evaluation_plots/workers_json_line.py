...
with open("energy_power_data_optuna_workers.json") as f:
    data = json.load(f)
...
# Example: Add vertical dotted line at 261 seconds (4.35 minutes)
ax1.axvline(146/60, color='gray', linestyle=':', linewidth=2, label='Deploy/ Run')
ax1.axvline(3560/60, color='gray', linestyle=':', linewidth=2, label='Run/ Deprovision')
