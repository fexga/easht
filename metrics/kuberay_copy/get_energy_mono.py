...
params = {
    ...
    "start": "2025-07-20T17:30:00Z",
    "end": "2025-07-20T18:30:00Z",
    "step": "3s"
}
...
with open("energy_total_data_ray.json", "w") as f:
    json.dump(data, f, indent=2)
print("Prometheus data saved as energy_total_data_ray.json")
...
fig.tight_layout()
plt.savefig("energy_total_plot_ray.png")
print("Plot saved as energy_total_plot_ray.png")
